...
- 제공자가 사용자에게 플랫폼을 제공함으로써 비즈니스 애플리케이션을 개발, 실행, 관리할 수 있도록 하는 것 
...
- API 개발 및 관리 : 마이크로서비스 개발, 실행, 관리, 보호를 위한 api 개발 및 관리 
...
- 마스터 데이터 관리 : 핵심 비즈니스 데이터를 위한 단일 참조 지점 제공 (프로세스, 정책, 표준, 툴 등) 
